function [ x_LMPC, u_LMPC, x_cl_out, u_cl_out, IterationCost_out, SS] = LMPC_itEnlCompDir(x_cl, u_cl, IterationCost, A, B, Q, R, N, Iterations, X, U, LMPC_options, goalSet)
